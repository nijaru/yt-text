...
# Set cache directories to /tmp before importing transformers
...
def summarize_text(text):
    # Create a temporary directory for any cache files
    with tempfile.TemporaryDirectory(dir="/tmp") as temp_dir:
        ...
        for chunk in chunks:
            try:
                ...
                print(
                    f"Error summarizing chunk: {chunk[:100]}... - {e}", file=sys.stderr
                )
                raise
